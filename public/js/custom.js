...
/**
 * Sum all numeric items in the array.
 * @param {'int'|'float'} [type='float'] - Return type. 'int' to round to integer.
 */
Array.prototype.sum = function (type='float') {
	return this.reduce((total, n) => {
		let val = type=='float' ? parseFloat(n) : parseInt(n);
